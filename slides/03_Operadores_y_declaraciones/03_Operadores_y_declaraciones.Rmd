...
- La instrucción "if else" nos permite ejecutar un bloque de código cuando no se cumple con la condición evaluada por la instrucción "if". 
...
- La instrucción "if else" nos permite ejecutar un bloque de código cuando no se cumple con la condición evaluada por la instrucción "if" y se necesite más de una instrucción. 
